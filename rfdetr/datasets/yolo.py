...
def match_image_label_pairs(
    ...
    if len_image_paths != len_label_paths:
        print(
            f"Warning: Found {len_image_paths} images and {len_label_paths} labels. Matching will be performed based on file names."
        )
...
class YOLODataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        print(
            f"Loaded {len(self.class_names)} classes from YOLO dataset: {self.class_names}"
        )
